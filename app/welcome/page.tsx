    ...
    return (
      <div className="r-home-bg r-welcome-viewport flex items-center justify-center">
        <div className="r-welcome-inner flex w-full justify-center py-10">
          <p className="text-[14px] text-text-3">Loading your profile…</p>
        </div>
      </div>
    );
  }
    ...
    <div className="r-home-bg r-welcome-viewport">
      <div className="r-welcome-inner pb-[max(5rem,env(safe-area-inset-bottom)+24px)] pt-[max(1.25rem,calc(env(safe-area-inset-top)+20px))]">
        <header className="r-home-hero relative w-full overflow-hidden px-5 py-8 sm:px-8 sm:py-10 lg:px-10 lg:py-11">
          <div className="pointer-events-none absolute left-0 top-0 h-full w-1 bg-gradient-to-b from-brand/80 via-brand/30 to-transparent" />
          <div className="flex flex-col items-center gap-6 sm:flex-row sm:items-start sm:gap-8 sm:text-left lg:gap-10 xl:gap-12 2xl:gap-14">
            <div className="shrink-0 rounded-2xl border border-stroke bg-surface p-4 shadow-[0_10px_28px_rgba(18,16,12,0.08)]">
              <Image
              ...
              <div className="mt-8 border-t border-stroke/80 pt-6">
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:gap-4">
                  ...
                  <Link
                    ...
                    prefetch={false}
                    className="relative z-10 inline-flex min-h-[48px] w-full min-w-0 flex-1 items-center justify-center rounded-[10px] border-2 border-brand bg-surface px-4 py-3.5 text-center text-[15px] font-semibold leading-snug text-brand-text no-underline shadow-sm transition hover:bg-brand/12 active:scale-[0.99]"
                  >
                    Create my riding family
                  </Link>
                </div>
                <p className="mt-3 text-center text-[12px] leading-relaxed text-text-3 sm:text-left">
                  <span className="font-semibold text-text">Riding family:</span> save one rider now,
        ...
        <section className="mt-6" aria-label="Continue on another device">
          <h2 className="mb-2 text-[13px] font-bold uppercase tracking-[0.12em] text-text-3">
        ...
        <section className="mt-8" aria-labelledby="welcome-why-heading">
          <h2
            ...
            className="text-center text-[13px] font-bold uppercase tracking-[0.12em] text-text-3 sm:text-left"
          >
          ...
          <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4">
            <FeatureBlock title="Research that stays personal">
              ...
              <strong className="font-semibold text-text">match %</strong> that react to how you ride
            ...
            <FeatureBlock title="Household riders">
              ...
              <strong className="font-semibold text-text">several riders</strong> — each with a photo,
            ...
            <FeatureBlock title="Privacy by design">
              ...
              servers. Use <strong className="font-semibold text-text">Export my data</strong> on your
              first device and <strong className="font-semibold text-text">Import</strong> here or in
        ...
        <section className="r-stat-card mt-8 px-5 py-6 sm:px-7" aria-labelledby="welcome-steps-heading">
          ...
          <ol className="mt-4 space-y-4 text-[13px] leading-relaxed text-text-3">
            <li className="flex gap-3">
              <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-brand/12 text-[12px] font-bold text-brand-text">
                1
              </span>
              <span>
            ...
            <li className="flex gap-3">
              ...
              <span>
                <strong className="text-text">Ride & refine.</strong> Log current bikes, plan trips, add
        ...
        <section className="mt-10 border-t border-stroke/70 pt-8" aria-label="Start again after reading">
          <p className="mb-3 text-center text-[13px] font-medium text-text-3 sm:text-left">Ready?</p>
          <div className="flex flex-col gap-3 sm:flex-row sm:gap-4">
            <Link
              href={welcomeSetupHref(queryKey, "solo")}
              prefetch={false}
