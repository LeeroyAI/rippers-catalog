...
export default function OfflinePage() {
  return (
    <main className="flex min-h-dvh w-full flex-col items-center justify-center bg-bg px-6 py-12 md:px-10">
      <section className="w-full max-w-md rounded-2xl border border-stroke bg-surface p-8 text-center shadow-sm">
        <h1 className="text-[22px] font-bold tracking-tight text-text">You are offline</h1>
