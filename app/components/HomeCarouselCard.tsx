...
export default function HomeCarouselCard({ bike, matchPct, onMatchClick }: Props) {
  ...
  return (
    <article className="r-carousel-card group relative flex flex-col overflow-hidden rounded-[1.125rem] border border-stroke bg-surface shadow-[0_12px_40px_rgba(18,16,12,0.12)] ring-1 ring-stroke/[0.02]">
      <Link
